...
public class DummyDataService {
    ...
    public void createDummyData() {
        ...
        // CUSTOM 타입 질문들
        questions.add(Question.createCustom("자바의 특징에 대해 설명해주세요."));
        questions.add(Question.createCustom("스프링 프레임워크의 핵심 개념은 무엇인가요?"));
        ...
        questions.add(Question.createDefault("5년 후 본인의 모습을 그려보세요.", "커리어 비전과 성장 계획"));
        questions.add(Question.createDefault("팀워크에서 중요하게 생각하는 것은?", "소통, 협력, 상호 존중"));
        questions.add(Question.createDefault("스트레스를 받을 때 어떻게 해결하시나요?", "개인만의 스트레스 해소 방법"));
