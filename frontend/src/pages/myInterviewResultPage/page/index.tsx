...
function MyInterviewResultPage() {
  return (
    <main
      aria-label="my-interview-result-page"
        ...
        <header className="mb-8 flex items-end justify-between px-4">
          <div className="space-y-1">
            ...
            <p className="text-sm text-gray-500">
              내가 진행한 면접 기록을 확인할 수 있습니다.
            </p>
          </div>
          <GoToButton
            to="/"
            label="interview-start-button"
            text="인터뷰 하러 가기"
          />
        </header>
...
export default MyInterviewResultPage;
